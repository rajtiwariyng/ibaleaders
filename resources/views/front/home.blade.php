      ...
      <div class="container">
        <div class="page-inner">
          <div class="dashboard-slider">
            <div class="whiteBox bg-white p-4">
              <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <p class="mb-0"><strong>Renewal Due Date: <?php echo date("d M Y", strtotime($user->renewal_due_date));?></strong></p>
              </div>
          ...
          <div class="col-md-4">
              ...
              <div class="whiteBox bg-white p-4 mt-4 ">
                <h6 class="blue poppins-bold pb-2 fs-6 fw-600">Individual Leader Presentation: </h6>
                <!-- <div class="blue poppins-bold fs-6 fw-600 Revenue-number">
                  <img src="images/ceus.png" alt=""> 
                  <p class="blue poppins-bold fs-4">1765852</p>
                </div> -->
                <div class="mb-2">
                  <button class="bg-blue btn text-white fs-8" data-bs-toggle="modal" data-bs-target="#modalIndividualLeaderPresentation" type="button">View</button>
                  <!-- <button class="bg-blue btn text-white fs-8" type="button">Review</button> -->
                </div>
              ...
              <div class="whiteBox bg-white p-4 mt-4">
                ...
                <div class="progress-data">
                  ...
                  ?>
                  <div class="progress-dial" id="progressDial" data-value="{{$processper}}">
...
<!-- Modal -->
<div class="modal fade" id="modalIndividualLeaderPresentation" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title fs-5 blue" id="exampleModalLabel">Individual Leader Presentation</h2>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="individualPostForm" class="vrForm pt-2" method="POST">
                  @csrf
                 @method('POST')
          <div class="row">
            <div class="col-md-12 form-group">
              <p class="fs-8 mb-1">(start by introducing your business tagline)</p>
            ...
            <div class="mb-2 text-center">
            <div id="individualsuccessMsgPost" class="text-success mt-3" style="display: none;"></div>
              <button class="bg-blue btn text-white fs-6" onclick="individualSubmitForm()" type="button">Submit</button>
              <button class="bg-blue btn text-white fs-6" type="button">Close</button>
            </div>
...
<script src="{{ asset('front-assets/js/chart.min.js') }}"></script>
  ...
  <script>
    ...
    function individualSubmitForm() {
        // Clear previous error messages
        $('.text-danger').text('');
        var formData = new FormData(document.getElementById("individualPostForm"));
        $.ajax({
            url: "{{ route('user.individualpost') }}",
            method: "POST",
            data: formData,
            async: true,
            processData: false,
            ...
            success: function(response) {
                ...
                $('#individualsuccessMsgPost').text(response.message).show();
                $('#individualPostForm')[0].reset();
                
                 
                
                setTimeout(() => {
                    $('#individualsuccessMsgPost').fadeOut();
                }, 2000);
                setTimeout(function () {
                  location.reload();
			              }, 3000);
            ...
            error: function(xhr) {
                ...
                if (xhr.responseJSON.errors) {
                    ...
                    $('#individualsuccessMsgPost').text("An error occurred. Please try again.").css('color', 'red').show();
                }
            }
        });
    }
