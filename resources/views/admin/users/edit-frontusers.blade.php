        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" action="{{ route('admin.frontedUsers.update', $user->id) }}" method="POST">
              	@csrf
                @method('PUT')
                <div class="card-body">
             ...
             @if($user->hasRole('user'))
                <div class="form-group">
                    ...
                    <input type="text" name="industry" id="industry" class="form-control" value="{{ old('industry', $user->industry) }}">
                    @error('industry')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
